...
<div class="container p-0">
  ...
  <div class="carousel-inner">
    ...
    <a href="{{ route('product.index') }}"><img class="d-block w-100" src="{{ asset('/storage/slides/slideshow_3.jpg') }}" alt="First slide" height="300" width="100%"></a>
    </div>
    <div class="carousel-item">
      <a href="{{ route('product.index') }}"><img class="d-block w-100" src="{{ asset('/storage/slides/1.jpg') }}" alt="Second slide" height="300" width="100%"></a>
    </div>
    <div class="carousel-item">
    <a href="{{ route('product.index') }}"><img class="d-block w-100" src="{{ asset('/storage/slides/2.webp') }}"  height="300" width="100%"></a>
    </div>
  </div>
...
<div class="collapse navbar-collapse " id="navbarNav" >
    <ul class="navbar-nav" >
      ...
      <li class="nav-item">
        <a ><img src="{{ asset('/storage/icon/logo-asus-149x40.png') }}"  alt="" style="margin-right:40px;"></a>
      </li>
      <li class="nav-item">
